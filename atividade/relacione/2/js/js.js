...
audio1 = new Audio('audio/colher.mp3');
audio2 = new Audio('audio/ralo.mp3');
audio3 = new Audio('audio/prato.mp3');
audio4 = new Audio('audio/copo.mp3');
audio5 = new Audio('audio/faca.mp3');
audio6 = new Audio('audio/panela.mp3');
