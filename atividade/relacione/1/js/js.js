...
audio1 = new Audio('audio/mao.mp3');
audio2 = new Audio('audio/pe.mp3');
audio3 = new Audio('audio/cabeca.mp3');
audio4 = new Audio('audio/barriga.mp3');
audio5 = new Audio('audio/ombro.mp3');
audio6 = new Audio('audio/joelho.mp3');
