...
audio1 = new Audio('audio/cidade.mp3');
audio2 = new Audio('audio/fazenda.mp3');
audio3 = new Audio('audio/floresta.mp3');
audio4 = new Audio('audio/montanha.mp3');
audio5 = new Audio('audio/parque.mp3');
audio6 = new Audio('audio/praia.mp3');
