...
window.onload = function(){
  document.getElementById('data').innerHTML = (now.getDate() + " do " + (now.getMonth()+1) + " de " + now.getFullYear() );
}
...
audio2 = new Audio('audio/meias.mp3');
audio3 = new Audio('audio/peixe.mp3');
audio4 = new Audio('audio/calca.mp3');
audio5 = new Audio('audio/camiseta.mp3');
audio6 = new Audio('audio/cachorro.mp3');
audio7 = new Audio('audio/galinha.mp3');
audio8 = new Audio('audio/laranja.mp3');
audio9 = new Audio('audio/maca.mp3');
audio10 = new Audio('audio/passaro.mp3');
audio11 = new Audio('audio/camisa.mp3');
audio12 = new Audio('audio/morango.mp3');
